      ...
      <div className="resume-layout">
        <div className="resume-container" id="about_me">
          ...
          <p className="resume-body">
            ...
            painting.
            <br /> Full Stack Developer with 5 years experience in the areas of
          ...
          <div className="resume-body">
            <div className="project-overview">
              ...
              <ul>
                ...
                <li>
                  Cooperating and communicating with other team members for efficient
                  work.
                </li>
                <li>
                  Managing and providing support and guidance to other team members.
                </li>
