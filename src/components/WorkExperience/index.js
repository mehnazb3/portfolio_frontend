...
const WorkExperience = () => {
  return <WorkExperienceWrapper id='work_experience'>
    <Row gutter={[32, 32]} style={{justifyContent: 'flex-end'}}>
      ...
      <Col span={16}>
        <CardWrapper>
            <Row gutter={[30, 30]}>
              <Col span={6}>
                <Card title="Tata Innoverse" style={{ backgroundImage: 'linear-gradient(to right, #4F95BD , #21CEB5)' }}>
              ...
              <Col span={6}>
                <Card title="The TataEdge" style={{ backgroundImage: 'linear-gradient(to right, #4F95BD , #21CEB5)' }}>
                  <p>Role - Technical Lead</p>
              ...
              <Col span={6}>
                <Card title="GIMS" style={{backgroundImage: 'linear-gradient(to right, #4F95BD , #21CEB5)' }}>
                  <p>Role - Technical Lead</p>
                  <p>Primary Technology - Ruby on Rails</p>
              ...
              <Col span={6}>
                <Card title="I2I" style={{backgroundImage: 'linear-gradient(to right, #4F95BD , #21CEB5)' }}>
                  <p>Role - Technical Lead</p>
                  <p>Primary Technology - Ryby on Rails</p>
